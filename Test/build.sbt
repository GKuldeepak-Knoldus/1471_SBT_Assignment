...
lazy val persistence = project.in(file("persistence")).settings(
 ...
 "org.scalatest" %% "scalatest" % "3.3.0-SNAP2" % Test , "org.eclipse.dirigible" % "dirigible-database-h2" % "5.6.0" % Test , "com.typesafe.akka" %% "akka-persistence-testkit" % "2.6.10" % Test
)
)
